...
export async function POST(req) {
  try {
    ...
    const tradeData = {
      transaction_id,
      wallet_address,
      price, // Actual executed price
      current_price: current_price || price, // Market price at time of trade
      expected_price: expected_price || null, // Slippage-adjusted expected price
      type,
      created_at,
